...
export class InsertPersonaProvaComponent implements OnInit {
  ...
  constructor(
    ...
    private serviceRegione: RegioneService,
    private servicePaese: PaesiService,
    private serviceSocieta: SocietaService,
    private serviceProvince: ProvinceService,
    private serviceComune: ComuniService
  ) {
  ...
  onRegionChangeDomicilio(event: any) {
    ...
    this.serviceProvince.getProvinceByRegione(idRegione).subscribe((province: any) => {
  ...
  insertUser() {
    if (this.insertPersona.valid) {
      this.auth.insertPersona(this.insertPersona.value).subscribe({
        next: (res) => {
  ...
  onChangeProvinciaDomicilio(event: any) {
    ...
    this.serviceComune.getComuniByProvinceId(idProvince).subscribe((comuni: any) => {
