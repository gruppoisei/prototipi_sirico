...
export class GestioneContrattoComponent implements OnInit {
  ...
  mappingContratto() {
    ...
    if (this.dipendenteConContratto.smartWorking == 0) {
    ...
    this.inserimentoContrattoService.insertNuovoContratto(this.formData).subscribe(
      (response: any) => {
        ...
        this.ricercaFiltrata(
          this.formDataSearch.AnpeNome,
          this.formDataSearch.AnpeCognome,
          this.formDataSearch.AnpeCodicefiscale,
          this.formDataSearch.AnsoSocietaid
        )
      },
      (error: any) => {
