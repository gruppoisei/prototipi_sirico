...
export class AggiungiAssenzaComponent {
  ...
  @Output() nuovaAssenzaInserita = new EventEmitter()
  ...
  uploadDoc() {
    //ATTENZIONE: IL BACKEND NON SI ASPETTA QUESTI CAMPI, LI IGNORERÀ!!
  ...
  checkFormValidity(): boolean {
    return this.formData.RiasFkTiporichiesta && this.DataInizio && this.DataFine && this.OraInizio && this.OraFine && this.formData.RiasNote
  }
