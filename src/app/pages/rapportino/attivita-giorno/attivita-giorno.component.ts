...
export class AttivitaGiornoComponent {
  ...
  constructor(
    ...
    if (data.giorno.giornoLavorativoId != undefined) this.giorno.giornoLavoroId = data.giorno.giornoLavorativoId
  ...
  VerificaGiorno() {
    ...
    oreGiornoConvertiteDaTempo =
      ...
      (Number(this.giorno.oraFinePausa!.split(':')[0]) - Number(this.giorno.oraInizioPausa!.split(':')[0])) +
      (Number(this.giorno.oraUscita!.split(':')[1]) -
        Number(this.giorno.oraEntrata!.split(':')[1]) -
        (Number(this.giorno.oraFinePausa!.split(':')[1]) - Number(this.giorno.oraInizioPausa!.split(':')[1]))) /
        60
