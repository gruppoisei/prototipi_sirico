...
export class InsertUtenteService {
  ...
  GetById(id: number): Observable<PersoneEntity> {
    return this.Http.get<PersoneEntity>('http://localhost:5112/Persone/GetPersoneById/' + id)
  }
  ...
  addPersona(persona: PersoneEntity): Observable<PersoneEntity> {
    ...
    return this.Http.post<PersoneEntity>('http://localhost:5112/Persone/InserimentoPersona/', body, this.httpOptions)
  }

  // GET ALL PERSONE
  GetAll(): Observable<PersoneEntity> {
    return this.Http.get<PersoneEntity>('http://localhost:5112/Persone/GetAllPersone')
  }
}
